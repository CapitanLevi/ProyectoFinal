...
//   this->adjustSize();//
    ...
    rectangles.append(scene->addRect(150,200,0,100,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(350,150,0,100,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(650,200,0,100,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(950,150,0,100,QPen(Qt::black),QBrush(Qt::red)));
    ...
    parabolico= new EsferaGraf(20,300,10,masa,v_limit);
...
void Nivel6::bordercollision(EsferaSim *b)
{
...
void Nivel6::keyPressEvent(QKeyEvent *event)
{
...
void Nivel6::keyReleaseEvent(QKeyEvent *event)
{
