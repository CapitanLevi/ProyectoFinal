...
//   this->adjustSize();//
    ...
    rectangles.append(scene->addRect(200,50,0,300,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(800,50,0,300,QPen(Qt::black),QBrush(Qt::red)));
    ...
    for(int i=0;i<bars.size();i++){
        ...
        for(int j=0;j<rectangles.size();j++){
            if(bars.at(i)->collidesWithItem(rectangles.at(j))){
                bars.at(i)->getEsf()->setVel(-0.6*bars.at(i)->getEsf()->getVx(),
...
void Nivel3::bordercollision(EsferaSim *b)
{
