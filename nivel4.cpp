...
//   this->adjustSize();//
    ...
    rectangles.append(scene->addRect(300,50,0,100,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(800,50,0,100,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(100,100,0,50,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(400,300,0,200,QPen(Qt::black),QBrush(Qt::red)));
    rectangles.append(scene->addRect(700,300,0,100,QPen(Qt::black),QBrush(Qt::red)));
...
void Nivel4::bordercollision(EsferaSim *b)
{
...
void Nivel4::keyPressEvent(QKeyEvent *event)
{
...
void Nivel4::keyReleaseEvent(QKeyEvent *event)
{
